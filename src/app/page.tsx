        ...
        <div className="relative flex h-full items-center justify-center text-center">
          <div className="text-white px-4 max-w-4xl">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/restaurants" className="px-6 py-3 bg-yellow-500 text-black font-medium rounded-xl hover:bg-yellow-600 shadow-lg transition-colors">
                Explorar Restaurantes
              </Link>
              <Link href="/hotels" className="px-6 py-3 bg-white text-gray-800 font-medium rounded-xl hover:bg-gray-100 shadow-lg transition-colors">
                Encontrar Hotéis
              </Link>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-8">
            <Link href="/all-attractions" className="inline-block px-6 py-3 bg-yellow-500 text-black font-medium rounded-xl hover:bg-yellow-600 shadow-lg transition-colors">
              Ver Mais Locais
            </Link>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="md:w-1/2">
              ...
              <p className="text-gray-700 mb-4">
                O município de Belas, localizado na província de Luanda, é um dos destinos mais promissores de Angola para turismo e lazer. Com uma riqueza cultural única e paisagens deslumbrantes, Belas oferece experiências inesquecíveis para todos os visitantes.
              </p>
              <p className="text-gray-700 mb-6">
                Desde a gastronomia local até as atrações turísticas, cada canto do município tem uma história para contar. A hospitalidade angolana se destaca em cada estabelecimento, tornando sua visita ainda mais especial.
              </p>
              <Link href="/about-belas" className="inline-block px-6 py-3 border-2 border-yellow-500 text-yellow-500 font-medium rounded-xl hover:bg-yellow-500 hover:text-white transition-colors">
                Saiba Mais
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 p-6 rounded-xl shadow">
              ...
              <p className="text-gray-700">
                "A gastronomia de Belas é incrível! Experimentei pratos tradicionais angolanos que nunca tinha provado antes. Os restaurantes são aconchegantes e o atendimento é maravilhoso."
              </p>
            ...
            <div className="bg-gray-50 p-6 rounded-xl shadow">
              ...
              <p className="text-gray-700">
                "Os hotéis em Belas oferecem excelente custo-benefício. Fiquei impressionado com a hospitalidade dos angolanos e com a beleza natural da região. Voltarei com certeza!"
              </p>
              <div className="mt-3 flex">
                {[1, 2, 3, 4, 5].map((star) => (
                  <span key={star} className="text-yellow-500">⭐</span>
        ...
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-3 max-w-xl mx-auto">
            <input 
              ...
              required
            />
            <button type="submit" className="px-6 py-3 bg-black text-white font-medium rounded-xl hover:bg-gray-800 transition-colors">
              Inscrever-se
            </button>
          </form>
        </div>
